...
/*Angular comes with its own HTTP library that we will use 
to communicate with a REST API to grab some data and display it on our template using HTTPclient.*/
